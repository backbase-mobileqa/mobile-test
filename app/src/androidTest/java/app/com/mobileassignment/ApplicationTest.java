...
public class ApplicationTest {
    ...
    public static final String STRING_TO_BE_TYPED = "Paris";
    public static final String CHARACTER_TO_BE_TYPED = "b";
    public static final String NON_EXISTING_CITY_TO_BE_TYPED = "dfjhd";
